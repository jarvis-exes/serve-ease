...
export const OrderCard: React.FC<OrderCardProps> = ({
    ...
    >
            ...
            <div className="flex flex-col gap-1 py-3">
                {order.orderItems?.map((item) => (
                    <div
                        ...
                        className="flex gap-2 justify-between items-center font-semibold"
                    >
                        <div className="flex gap-2 items-center">
                            <span>{item.name}</span>
                            <span
                                className={twMerge(
                                    "px-1.5 rounded-sm text-sm",
                                    sizeColors[item.size],
                                )}
                            >
                                {item.size}
                            </span>
        ...
        <div className="flex justify-center items-center gap-3 pt-3 border-t-2 border-gray-300">
            {showPrice && (
            ...
            {showButton && (
                <Button
                    className={twMerge("w-full rounded-xl text-white", buttonColor)}
